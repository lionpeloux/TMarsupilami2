...
namespace TMarsupilami.Gh.Component
{
    public class Comp_CenterlineProperties : GH_Component
    {
        ...
        public Comp_CenterlineProperties()
          : base("Centerline Properties - Circumbscribed / Rotation", "Centerline (CIRC / ROT)",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (isClosed)
            {
                Centerline.Closed_GetCurvature(frames, x, e, u, l, t, κb, τ);
                Centerline.Closed_AlignFrames(frames, t);
                Centerline.Closed_GetTwist(frames, l, τ);
            ...
            {
                Centerline.Open_GetCurvature(frames, x, e, u, l, t, κb, τ);
                Centerline.Open_AlignFrames(frames, t);
                Centerline.Open_GetTwist(frames, l, τ);
