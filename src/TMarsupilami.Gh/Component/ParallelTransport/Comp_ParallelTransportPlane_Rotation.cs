...
namespace TMarsupilami.Gh.Component
{
    public class Comp_ParallelTransportPlane_Rotation : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            frame = frame.ParallelTransport(frame.ZAxis, point_list[0].Cast(), direction_list[0].Cast());
            ...
            for (int i = 1; i < point_list.Count; i++)
            {
                ...
                frame = frame.ParallelTransport(planes_pt[i-1].ZAxis.Cast(), point_list[i].Cast(), direction_list[i].Cast());
