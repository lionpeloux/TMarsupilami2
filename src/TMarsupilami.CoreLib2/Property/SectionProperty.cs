...
namespace TMarsupilami.CoreLib2
{
    ...
    public class SectionProperty : Property
    {
        #region FIELDS
        ...
        #region CONSTRUCTORS
        public SectionProperty(int id, SectionType type)
            :base(id, PropertyType.Section)
        {
            SectionType = type;
        }

        public static SectionProperty RectangularSection(double b1, double b2)
        {
            SectionProperty section_prop = new SectionProperty(0, SectionType.Rectangular);
