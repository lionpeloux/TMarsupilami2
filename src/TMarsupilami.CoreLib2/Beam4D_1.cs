...
{
    public class Beam4D_1 : IElement, IDRElement
    {
        ...
        public Beam4D_1(BeamLayout layout, MaterialProperty materialProp, SectionProperty[] sectionProp)
        {
            Layout = layout;
            nv = Layout.Nv;
            ne = Layout.Ne;
        ...
        void IDRElement.Move(MVector[] dx)
        {
            throw new NotImplementedException();
        }

        void IDRElement.Move(double[] dθ)
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateCenterlineProperties()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateCurvatureBinormal()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateMaterialFrame()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateBendingMoment()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateTwistingMoment()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateInternalNodalMoment()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateResultantNodalMoment()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateAxialForce()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateShearForce()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateInternalNodalForce()
        {
            throw new NotImplementedException();
        }

        void IDRElement.UpdateResultantNodalForce()
        {
            throw new NotImplementedException();
        }

        void IDRElement.Update_lm_x(ref double[] lm_x)
        {
            throw new NotImplementedException();
        }

        void IDRElement.Update_lm_θ(ref double[] lm_θ)
        {
            throw new NotImplementedException();
        }
    }
